...
public class StrategyBoardTest {
    ...
    @Test
    public void shouldNotBeAbleToDetectACatsGameIfThereIsNoPossibleWinningMoveAndTheBoardIsEmpty() {
        StrategyBoard board = new StrategyBoardImpl(constants.SIDE, players);
        assertThat(board.detectCatsGame(player2, player1), is(false));
    }

    @Test
    public void shouldNotBeAbleToDetectACatsGameIfThereIsNoPossibleWinningMoveAndTheBoardIsFull() {
        players[1] = player1;
        players[2] = player2;
        players[3] = player2;
        players[4] = player1;
        ...
        players[8] = player2;
        StrategyBoard board = new StrategyBoardImpl(constants.SIDE, players);
        assertThat(board.detectCatsGame(player2, player1), is(true));
    }
    ...
    //   X|O|
    @Test
    public void shouldBeAbleToDetectACatsGameIfThereIsNoPossibleWinningMoveAndTheBoardIsNotEmpty() {
        players[1] = player1;
        players[2] = player2;
        players[3] = player2;
        players[4] = player1;
    ...
    //    | |
    @Test
    public void shouldNotBeAbleToDetectACatsGameIfThereIsAPossibleWinningMoveAndTheBoardIsNotEmpty() {
        players[1] = player1;
        players[3] = player2;
        players[4] = player2;
        StrategyBoard board = new StrategyBoardImpl(constants.SIDE, players);
    ...
    //    | |
    @Test
    public void shouldNotBeAbleToDetectACatsGameIfThereIsAPossibleWinningMoveForOpponentAndTheBoardIsNotEmpty() {
        players[1] = player1;
        players[3] = player2;
        players[4] = player1;
        StrategyBoard board = new StrategyBoardImpl(constants.SIDE, players);
